...
const Section1: Lyric[] = [
	...
	{ type: "text", start: "28600", duration: "1460", appendBr: true, text: "because we can." },
...
const Section5: Lyric[] = [
	...
	{ type: "text", start: "5500", duration: "1500", appendBr: true, text: "Portal" },
	{
		...
		duration: "1500",
		appendBr: true,
		text: "'Still Alive' ending scene"
	},
	{ type: "text", start: "8500", duration: "1500", appendBr: true, text: "remade with svelte" },
	...
	{ type: "br", showOffset: "12500" },
	{
		...
		duration: "600",
		appendBr: true,
		text: " Copyright 2007- Valve Corporation."
	},
	{
		type: "text",
		start: "13600",
	...
	},
	{
		...
		duration: "1500",
		appendBr: true,
		text: " Valve, Steam, Portal are trademarks"
	},
	{
		type: "text",
		start: "16000",
		duration: "1500",
		appendBr: true,
		text: " and/or registered trademarks of"
	},
	{
		type: "text",
		start: "17500",
...
class LyricRenderer {
	...
	protected ascii: Writable<ASCII>;
	protected cursor: Cursor;

	constructor(container: HTMLDivElement, ascii: Writable<ASCII>, cursor: Cursor) {
		this.container = container;
		this.ascii = ascii;
		this.cursor = cursor;
	}

	setContainer(newContainer: HTMLDivElement) {
		if (this.container) {
		...
		switch (lyric.type) {
			case "text": {
				...
				createTimeout(
					"still-alive",
					() => {
						if (lyric.ascii) this.ascii.set(lyric.ascii);
						typeOneByOne(text, lyric.text, parseInt(lyric.duration), lyric.appendBr, this.cursor);
					},
			...
			case "link": {
				...
				createTimeout(
					"still-alive",
					() => {
						typeOneByOne(link, lyric.text, parseInt(lyric.duration), lyric.appendBr, this.cursor);
					},
					parseInt(lyric.start)
				);
				break;
