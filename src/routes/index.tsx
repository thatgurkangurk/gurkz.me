...
export default function Home() {
    const query = useInfiniteQuery(() => orpc.music.getMusicIds.infiniteOptions({
        ...
        <>
            ...
            <Show when={query.isFetched && query.data}>
                            ...
                            {(musicId) => {
                                ...
                                return <p>
                                    ...
                                    <button onClick={() => {
                                        ...
                                        <Show when={isCopying()} fallback="copy">copied</Show>
                                    </button>
                                </p>
                            }
                ...
                <Show when={query.hasNextPage}>
                    <button onClick={() => query.fetchNextPage()} class="p-2 border-2 rounded-xl">fetch more</button>
                </Show>
            </Show>
        </>
