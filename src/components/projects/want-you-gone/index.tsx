...
function Ui() {
	return (
		<div id="ui">
			...
			<div id="uiright">
				<svg id="logo" viewBox="0 0 530 530">
...
export function WantYouGone() {
	...
	return (
		...
		>
			<div class={`wrapper ${hasStarted() ? "" : "invisible"}`}>
				<div id="container">
					<div id="lyrics" ref={lyricsDiv}>
						<div id="lyricstext" ref={lyricsText} />
					</div>
					<div id="credits" ref={creditsDiv}>
						<div id="creditstext" ref={creditsText} />
					</div>
					<Ui />
				</div>
				<div id="buffer" />
			</div>
			{/* biome-ignore lint/a11y/useMediaCaption: it's not needed */}
			<audio ref={audio}>
				<source src={musicmp3} />
			</audio>
		</Show>
